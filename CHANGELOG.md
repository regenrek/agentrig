...
- refactor(web): migrate from Solid.js to React and update project structure
  ...
  - Enhanced Vite configuration with new plugins and optimizations.
  - Cleaned up unused files and styles related to Solid.js.
  - Updated dependencies to align with the latest React and TanStack versions.
