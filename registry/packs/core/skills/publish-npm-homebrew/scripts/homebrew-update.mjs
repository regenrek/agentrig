...
// ─────────────────────────────────────────────────────────────────────────────
// CONFIGURE: Update CLI_DIR for your project
// ─────────────────────────────────────────────────────────────────────────────
const CLI_DIR = "cli";
...
const formula = `class ${formulaClass} < Formula
  ...
  def install
    ...
    # symlink the package's bin entrypoint explicitly.
...
function resolveHomepage(repository) {
  if (!repository) return "https://github.com/OWNER/REPO";
  const url = typeof repository === "string" ? repository : repository.url;
  if (!url) return "https://github.com/OWNER/REPO";
